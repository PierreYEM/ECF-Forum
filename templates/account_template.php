...
<div class="container py-5 col-8 d-flex justify-content-center">
  ...
  <form class="d-flex flex-column align-items-center col-10 col-lg-6 " action="index.php?action=submitModifyUser"
    method="post">
    <h2 class="text-center">Informations de l'utilisateur</h2>
    <div class="d-flex flex-column align-items-center justify-content-between col-12 col-md-8 p-5" style="height:50vh;">
      <div class="w-100">
        <div class="mb-4 border rounded-2 position-relative">
          ...
          <input name="name" type="text" class="form-control border-0 ps-5" id="pseudo" aria-describedby="pseudoInput"
