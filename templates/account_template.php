    ...
    <div class="accordion-item">
      ...
      <div id="formSubject" class="accordion-collapse collapse" aria-labelledby="headingOne"
        ...
        <div class="accordion-body d-flex justify-content-center">
          <form class="d-flex flex-column align-items-center col-10 col-lg-12 " action="" method="post">
            <div class="d-flex flex-column align-items-center justify-content-between col-12 col-md-8  col-lg-10 p-5"
              style="height:50vh;">
              <div class="w-100">
                <div class="mb-4 border rounded-2 position-relative">
